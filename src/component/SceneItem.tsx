...
interface SceneItemProps {
  scene: Scene;
  sceneIndex: number;
  onContentChange: (sceneIndex: number, contentIndex: number, field: string, value: string) => void;
}
...
const SceneItem: React.FC<SceneItemProps> = ({ scene, sceneIndex, onContentChange }) => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>, contentIndex: number, field: string) => {
          ...
          {content.type === "지문" ? (
            ...
            <>
              <Input
                ...
                onChange={(e) => handleInputChange(e, contentIndex, "character")}
                field="character"
              />
              {content.action &&
              <Input
