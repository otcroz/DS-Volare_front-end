      ...
      content: [
        {
          ...
          character: '집',
          dialog:
            '얘야, 할머니가 어떠신지 가보렴. 아주 아프시다는 말을 들었지 뭐니.',
          type: '대사',
        },
        {
          action: '',
          character: '집',
          dialog:
            '할머니께 이 핫케이크 하나와 여기 이 버터 작은 병을 가져다 드리렴.',
          type: '대사',
        },
        ...
        },
        {
          ...
          character: '엄마',
          dialog:
            '이 핫케이크 하나와 버터 작은 병을 엄마가 갔다드리라 하셨거든요.',
          type: '대사',
        },
        {
          action:
            '(가능한 한 빨리 달리기 시작해 가장 빠른 지름길을 택했어요.)',
          character: '마을,',
          dialog: '할머니 집이 머니?  ',
          type: '대사',
        },
        {
          action:
            '(나무열매들을 줍기도 하고, 나비들을 쫓기도 하고, 만나는 귀여운 꽃들로 꽃다발을 만드느라 정신이 팔려 가장 먼 길을 택해 나아갔어요.)',
          character: '마을,',
          dialog: '오!  네,',
          type: '대사',
        },
        ...
        {
          action:
            '(문을 닫고 할머니 침대 속으로 들어가 빨간 모자를 쓴 아이를 기다렸어요.)',
          character: '병',
          dialog: '그럼,',
          type: '대사',
        },
        ...
        },
        {
          ...
          character: '병',
          dialog:
            '난 이 쪽으로 갈 테니, 넌 저 쪽으로 가 보거라, 우리 중 누가 더 빨리 거기까지 가는지 보자꾸나.',
          type: '대사',
        },
      ],
      location: '길 위',
