                ...
                "content": [
                    {
                        "action": "(늑대 영감을 만났어요.)",
                        "character": "집",
                        "dialog": "얘야, 할머니가 어떠신지 가보렴, 아주 아프시다는 말을 들었지 뭐니, 할머니께 이 핫케이크 하나와 여기 이 버터 작은 병을 가져다 드리렴.  ",
                        "type": "대사"
                    },
                    ...
                    },
                    {
                        ...
                        "character": "병",
                        "dialog": "나도 늑대를 보러 가봐야겠는 걸.  난 이 쪽으로 갈 테니, 넌 저 쪽으로 가 보거라, 우리 중 누가 더 빨리 거기까지 가는지 보자꾸나.  ",
                        "type": "대사"
                    },
                    {
